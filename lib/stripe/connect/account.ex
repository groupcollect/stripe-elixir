defmodule StripeElixir.Account do
  use StripeElixir.API, [:create, :retrieve, :update, :list, :delete]

  def endpoint, do: "accounts"

  def reject(account_id, [reason: reason], opts \\ []) do
    StripeElixir.request(:post, "#{endpoint()}/#{account_id}/reject", [reason: reason], opts)
  end
  ...
  def create_external_account(account_id, [external_account: token_id], opts \\ []) do
    ...
    StripeElixir.request(:post, url, [external_account: token_id], opts)
  end
